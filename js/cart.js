                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        ...
                        <div class="card-text d-flex justify-content-between align-items-center">
                            <h6>${item.quantity}</h6>
                            <div>
                                <span onclick="window.decreaseQuantity(${item.id})"><i class="fa-solid fa-minus me-4 p-2 main-btn"></i></span>
                                <span onclick="window.increaseQuantity(${item.id})"><i class="fa-solid fa-plus p-2 main-btn"></i></span>
                            </div>
                        </div>
